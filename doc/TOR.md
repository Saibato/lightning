...
if --announce-addr is not specified only the auto generated onion addr will be used for your node.
...
sudo lightningd/lightningd --network=testnet --announce-addr=127.0.0.1 --port=1234
...
lightningd/lightningd --network=testnet --addr=127.0.0.1:1234 
