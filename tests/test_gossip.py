...
def test_statictor_onions(node_factory):
    ...
    try:
        l1 = node_factory.get_node(may_fail=True, options={'addr': ['127.0.0.1:1234',
                                                           'statictor:127.0.0.1:9051']})
        l2 = node_factory.get_node(may_fail=True, options={'addr': ['127.0.0.1:12345',
                                                           'statictor:127.0.0.1:9051:torblob:11234567890123456789012345678901']})
    except Exception:
        try:
            l1 = node_factory.get_node(may_fail=True, options={'addr': ['127.0.0.1:1234',
                                                               'statictor:127.0.0.1:9151']})
            l2 = node_factory.get_node(may_fail=True, options={'addr': ['127.0.0.1:12345',
                                                               'statictor:127.0.0.1:9151:torblob:11234567890123456789012345678901']})
        except Exception:
